...
var App = function () {
    ...
    {
    	$(".doExport").live("click", function()
    	{
    		App.block();
    		var $tbList = $(this).attr("data-toggle");
    		...
    		var title = replaceChar($title) + $time;
    		...
    		{
    			if(!$(this).hasClass("bs-checkbox") && $(this).attr("data-visible") != false && $(this)[0].style.display != "none")
    			{
    				columns += replaceChar($(this).text()) + " ,";
    			}
    		});
    		...
    		$tbList.find("tr").each( function ()
    		{
    			$(this).find("td").each( function ()
    			{
    				if(!$(this).hasClass("bs-checkbox") && $(this).attr("data-visible") != false && $(this)[0].style.display != "none")
    				{
    					if($(this).text() == "")
    					{
    						cnts += replaceChar($(this).find("input").val()) + " ,";
    					}
    					else
    					{
    						cnts += replaceChar($(this).text()) + " ,";
    					}
    				}
    			});
    			if(cnts != "")
    		...
    		$.post("index/doExport.do", {columns:columns, cnts:cnts, title:title}, function(data)
    		{
    		    open(data, "_self");
    		});
    		 App.unblock();
    ...
    return {
        ...
        init: function () {
            ...
            handleExport(); // handles export excel
        ...
        blockUI: function (el, centerY) 
        {
            ...
            el.block({
                    message: '<img src="/EMS/media/image/loading.gif" align="">',
