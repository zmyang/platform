...
<html lang="en" class="no-js">
	...
	<body class="page-header-fixed">
		...
		<div class="header navbar navbar-inverse navbar-fixed-top">
			...
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<a href="#nextBizDate" class="btn yellow" data-toggle="modal" data-trigger="hover" data-placement="bottom" data-original-title="当前营业日期" data-content="点击此处完成今天工作，日期变为下一天!"> 
						<i class="icon-calendar"></i> 营业日期：${C_BDT.bizDt}
						<input type="hidden" id="txtCurrentBizDate" value="${C_BDT.bizDt}">
					</a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <img alt="" src="<c:url value="/media/image/avatar1_small.jpg"/>" /> <span class="username">${C_USR.usrNm} [${C_STE.stNm}]</span> <i class="icon-angle-down"></i> </a>
		...
		<div id="nextBizDate" class="modal hide fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn green endOfDay">
					营业结束
				</button>
			</div>
		</div>
